...
public class Main implements TSDRLibrary.FrameReadyCallback, TSDRLibrary.IncomingValueCallback, TSDRSourceParamChangedListener, OnTSDRParamChangedCallback {
	...
	private void initialize() {
		...
		// Asanka: Updating the button to toggle between true and false each time the user click it
	...
	// Asanka: Edited this function to save snapshots continuously if the (snapshot variable is true
	@Override
